...
class Array { // общий родительский класс 
protected: 
...
class myArray: public Array<T,size> { // создаём класс-наследник 
public:
	myArray(){}
};
template <size_t size>
class myArray<char, size> : public Array<char, size> // создаём ещё один класс-наследник, но уже с частичной специализацией 
{
public:
